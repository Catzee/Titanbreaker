...
function BuildGameArray()
    ...
    game.rounds = _G.COverthrowGameMode.RoundCounter -- Rounds played
        ...
        if PlayerResource:IsValidPlayerID(playerID) then
            if not PlayerResource:IsBroadcaster(playerID) then
                ...
                table.insert(players, {
                    ...
                    ph = hero:GetUnitName(), -- Hero by its short name
                    ...
                    i1 = hero:GetItemInSlot(0):GetName(), -- Item Slot #1
                    i2 = hero:GetItemInSlot(1):GetName(), -- Item Slot #2
                    i3 = hero:GetItemInSlot(2):GetName(), -- Item Slot #3
                    i4 = hero:GetItemInSlot(3):GetName(), -- Item Slot #4
                    i5 = hero:GetItemInSlot(4):GetName(), -- Item Slot #5
                    i6 = hero:GetItemInSlot(5):GetName(), -- Item Slot #6
                })
            end
        end
    end
